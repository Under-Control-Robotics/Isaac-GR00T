...
pickle.dumps/loads instead of msgpack. This is for compatibility with the old UCR branch.

Use this for UCR branch compatibility. For new code, use server_client.py (msgpack-based).
"""
...
class PickleInferenceServer:
    ...
    This is for UCR branch compatibility. For new code, use PolicyServer from server_client.py.
    """
...
class PickleInferenceClient:
    ...
    This is for UCR branch compatibility. For new code, use PolicyClient from server_client.py.
    """
